...
LOWER1 = np.array([0, 120, 70])  # Lower bound for red
UPPER1 = np.array([10, 255, 255])  # Upper bound for red
LOWER2 = np.array([170, 120, 70])  # Second range for red
UPPER2 = np.array([180, 255, 255])  # Upper bound for red

# Yellow color range for detection
...
while True:
    ...
    # Red color detection (both ranges)
