...
# Load images
# ----------------------------
left_images = sorted(glob.glob("Stereo_pairs_2/left_*.png"))
right_images = sorted(glob.glob("Stereo_pairs_2/right_*.png"))
...
with open("stereo_calibration_2.pkl", "wb") as f:
    pickle.dump(calib_data, f)

print("Calibration saved to stereo_calibration_2.pkl")
